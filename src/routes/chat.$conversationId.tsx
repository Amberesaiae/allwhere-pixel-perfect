...
function ChatThread() {
  ...
  return (
    <div className="bg-white md:rounded-2xl md:border md:border-bk-beige flex flex-col h-[calc(100vh-4rem)] md:h-[calc(100vh-8rem)]">
      {/* Header */}
      <header className="flex items-center gap-3 px-4 py-3 border-b border-bk-beige">
      ...
      {/* Messages */}
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-3 md:px-4 py-4 space-y-1.5 bg-bk-page/40">
        {messages.length === 0 && (
      ...
      <form
        ...
        className="border-t border-bk-beige px-3 py-2.5 flex items-center gap-2 bg-white pb-[calc(0.5rem+env(safe-area-inset-bottom))]"
      >
...
// satisfy unused import linter for ImageIcon (used only in headless contexts)
void ImageIcon;
